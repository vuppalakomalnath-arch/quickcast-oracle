...
export const initialMarkets: Market[] = [
  ...
  },
  {
    ...
    isLive: true,
    oracleSources: [
      { name: "Bloomberg Terminal", result: "PENDING", confidence: 97 },
      { name: "SEC EDGAR Filing", result: "PENDING", confidence: 90 },
      { name: "CoinGlass Analytics", result: "PENDING", confidence: 85 },
    ],
    resolved: false,
  },
  {
    ...
    isLive: true,
    oracleSources: [
      { name: "DeFiLlama API", result: "PENDING", confidence: 93 },
      { name: "Algorand Indexer", result: "PENDING", confidence: 91 },
      { name: "Vestige Analytics", result: "PENDING", confidence: 87 },
    ],
    resolved: false,
  },
];
